...
class SessionManager:
    ...
    # ------------------------------------------------------------------
    # CONVENIENCE ALIASES
    # Short-form names for the most common operations. These exist so
    # test code and application code can use whichever form reads more
    # naturally in context. Both names are stable parts of the interface.
    # ------------------------------------------------------------------
    ...
    def start(
        ...
        """Alias for create_session. Preferred in application code for brevity."""
    ...
    def terminate(
        ...
        """Alias for end_session. Preferred in application code for brevity."""
        return self.end_session(token=token, audit_fn=audit_fn)
